...
| `qemu/qemu-system-arm.wasm` | the emulator, wasm64/TCI, md5 `7603dcf3304d69f5f590d4728a363cab` | [kmehltretter82/qemu](https://github.com/kmehltretter82/qemu) branch `armv4-boards`, public commit [`0f0e03dca12f`](https://github.com/kmehltretter82/qemu/commit/0f0e03dca12fc704c4491eb8fe7dc505a9c4d55c), built by `build/build-qemu.sh` with emsdk 4.0.10. The RiscPC subtype models the fitted SMC FDC37C665 as an 82077AA-compatible controller rather than exposing the shared core's 82078-only commands. | GPL-2.0 |
