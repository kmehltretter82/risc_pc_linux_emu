...
|---|---|---|---|
| `zImage` | Linux 7.2.0-rc4+ for `ARCH_RPC` (Acorn RiscPC) | [kmehltretter82/linux](https://github.com/kmehltretter82/linux) branch `riscpc-emu`, commit `36ea1cf6b8d1c802f4121a8032d4f5d58f5a8283` (= tag `v7.2-rc4` + 3 fix patches found on this emulated hardware) | GPL-2.0 |
